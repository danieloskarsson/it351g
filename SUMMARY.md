...
* [Test: Activities & Fragments](user-interface-screens/test-activities-and-fragments.md)

## Networking

* [JSON data](networking/json-data.md)
* [HTTP networking](networking/http-networking.md)
* [Test: JSON data](networking/test-json-data.md)
...
* [Test: SQLite](persistence/test-sqlite.md)

## External libraries

* [External libraries](external-libraries/external-libraries.md)
* [Test: External libraries](external-libraries/test-external-libraries.md)
